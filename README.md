...
4. If you want to populate data into database for testing - Run the command npm run seed
...
https://drive.google.com/file/d/1JaqqkFtMqIkPp_igYzzKQ2Kc3ooOlsjI/view
